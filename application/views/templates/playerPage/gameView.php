<script id="gameViewTemplate" type="text/template">
    ...
    <div class="row">
        <div class="col-xs-1"><img id="gameView_winner" src="img/avatars/2_<%=winner_id%>_1.png?ver=3" class="mediumAvatar roundAvatar avatarLink" /></div>
        <div class="col-xs-1"><span class="vs">vs...</span></div>
    	<div class="col-xs-8"><img id="gameView_winner" src="img/avatars/2_<%=loser_id%>_1.png?ver=3" class="mediumAvatar roundAvatar avatarLink" /></div>
    </div>
    <div class="row">
