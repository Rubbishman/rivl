Vs.NewGameView2 = Backbone.View.extend({
    ...
    _setPlayer: function(playerNumber, playerModel) {
        ...
        if(Vs.competition.get('id') == 2) {
            if (playerNumber === '1') {
                ...
                $('#selectPlayer1 img').attr('src', "img/avatars/" + Vs.competition.get('id') + "_" + playerModel.get('competitor_id') + "_1"+"?ver=2");
                ...
                $('#selectPlayer2 img').attr('src', "img/avatars/" + Vs.competition.get('id') + "_" + playerModel.get('competitor_id') + "_1"+"?ver=2");
            }
        } else {
            if (playerNumber === '1') {
                $('#selectPlayer1').attr('data-competitor_id', playerModel.get('competitor_id'));
    ...
    _renderResults: function(results) {
        ...
        if (results.p1eloDelta < 0) {
            if(Vs.competition.get('id') == 2) {
                $('#selectPlayer1 img').attr('src', "img/avatars/" + Vs.competition.get('id') + "_" + playerModel.get('competitor_id') + "_0"+"?ver=2");
            } else {
                $('#selectPlayer1 img').attr('src', "img/avatars/" + this._getImage(results.p1name, 'left', 'lose'));
            }
        } else {
            if(Vs.competition.get('id') == 2) {
                $('#selectPlayer2 img').attr('src', "img/avatars/" + Vs.competition.get('id') + "_" + playerModel.get('competitor_id') + "_0"+"?ver=2");
            } else {
